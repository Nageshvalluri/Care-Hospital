    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dapp.specialization')),
            ],
        ),
        migrations.CreateModel(
            name='AddPatient',
            fields=[
                ...
                ('regdate_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('doctor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dapp.doctorreg')),
            ],
        ),
        migrations.CreateModel(
            name='MedicalHistory',
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('pat_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='medical_histories', to='dapp.addpatient')),
            ],
        ),
        migrations.CreateModel(
            name='PatientReg',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('doctor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dapp.doctorreg')),
                ('pat_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='dapp.patientreg')),
                ('spec_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='dapp.specialization')),
            ],
        ),
    ]
